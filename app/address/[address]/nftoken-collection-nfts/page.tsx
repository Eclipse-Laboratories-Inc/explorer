...
export async function generateMetadata(props: AddressPageMetadataProps): Promise<Metadata> {
    return {
        description: `NFToken NFTs belonging to the collection ${props.params.address} on Eclipse`,
        title: `NFToken Collection NFTs | ${await getReadableTitleFromAddress(props)} | Eclipse`,
    };
}
